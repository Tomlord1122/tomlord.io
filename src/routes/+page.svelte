...
<div class="prose prose-sm sm:prose-base  mx-auto">
	...
	<main in:fly={{ y: 100, duration: 1000, delay: 600 }} 
		...
		<div class="flex gap-2">
			...
			<!-- linkedin -->
			<a href="https://www.linkedin.com/in/tom-liu-218a281b4/" class="inline-flex items-center gap-1 text-gray-700 hover:text-gray-900 ml-3">
				<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" class="inline">
		...
		<div class="flex flex-col justify-center items-start">
				<h3 class="text-lg font-extrabold underline underline-offset-1">Experience</h3>
			<ul>
				<li>
					<p class=" text-gray-800">HP Software Engineering Intern <strong>(Jul 2024 - Now)</strong></p>
				</li>
				<li>
					<p class=" text-gray-800">MediaTek System Research Assistant <strong>(Jan 2024 - Jul 2025)</strong></p>
